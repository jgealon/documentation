...
Prepare the MAX32625PICO itself with the MAX32666FTHR-specific DAPLink image from: `MAX32625PICO firmware images <https://github.com/analogdevicesinc/max32625pico-firmware-images>`_
...
(filename ``adalm-lsmspg.zip``) from: `ADALM-LSMSPG firmware (no-OS releases) <https://github.com/analogdevicesinc/no-OS/releases/tag/last_commit>`_
