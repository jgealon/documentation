...
The :adi:`Analog Devices Active Learning Module-Mixed-Mode Signal Chain <ADALM-MMSC>`
...
- 1x ADALM-MMSC Board
- 1x Pre-programmed MAX32666FTHR board
- 1x USB-A to Micro-USB cable
- 1x MAX32625PICO with 10-pin ribbon cable for SWD connection 
...
Requires `Scopy 2.1 or newer
<https://analogdevicesinc.github.io/scopy/index.html>`_.
...
1. Access the ADALM‑MMSC firmware source from the no‑OS repository:
   ...
   <https://github.com/analogdevicesinc/no-OS/tree/main/projects/adalm-mmsc>`_

2. Download the pre‑built firmware binaries from the no‑OS releases page:

   :git-no-OS:`ADALM‑MMSC releases </releases/tag/last_commit>`
