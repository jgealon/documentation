...
.. admonition:: Download
   ...
   - :download: `PCB Layout (pdf) <adalm-mmsc_revb_layout.pdf>`
   - :download: `Bill of Materials (csv) <adalm-mmsc_revb_bom.csv>`
   - :download: `Allegro Project (zip) <adalm-mmsc_revb_allegro_files.zip>`
   - Simulation Files
